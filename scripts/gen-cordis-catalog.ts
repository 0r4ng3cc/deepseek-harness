...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshSessionPath: 'not a service: boot-provided root accessor function (typeof dshSessionPath | undefined) for Loader config expressions — packages/boot/app-boot/README.md owns the boot contract',
  dshProfile: 'not a service: launcher-provided boot-context value (DshProfileRuntime | undefined) — packages/boot/app-boot/README.md owns the boot contract',
  ...
  tuiCommandTrees: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiDialogs: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiEffectLedger: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiMessageObserver: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiPluginHost: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiPluginStorage: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiRenderers: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiScenes: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiSettingsSections: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiShortcuts: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiStatus: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiThemes: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiToast: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
  tuiWorkspaces: 'TUI host service declared under packages/ui/tui/src/dsh-adapter; the host-face catalog projection does not render it — packages/ui/tui/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TuiCompactDecision: 'TUI compact decision is owned by packages/ui/tui/README.md',
  TuiCompactEvent: 'TUI compact event is owned by packages/ui/tui/README.md',
  TuiInputDecision: 'TUI input decision is owned by packages/ui/tui/README.md',
  TuiInputEvent: 'TUI input event is owned by packages/ui/tui/README.md',
  TuiRewindDoneEvent: 'TUI rewind-done event is owned by packages/ui/tui/README.md',
  TuiRewindPromptDecision: 'TUI rewind-prompt decision is owned by packages/ui/tui/README.md',
  TuiRewindPromptEvent: 'TUI rewind-prompt event is owned by packages/ui/tui/README.md',
  TuiSessionSwitchDecision: 'TUI session-switch decision is owned by packages/ui/tui/README.md',
  TuiSessionSwitchEvent: 'TUI session-switch event is owned by packages/ui/tui/README.md',
  TuiSessionSwitchedEvent: 'TUI session-switched event is owned by packages/ui/tui/README.md',
}
