...
| `dsh --profile tui` | Open the interactive terminal chat until the TUI unmounts. |
...
Bundles named in `dsh.profile.bundles` resolve from the dsh installation first (`@x1a0f3n9/dsh-base`, `@x1a0f3n9/dsh-web-app`, `@x1a0f3n9/dsh-headless`, `@x1a0f3n9/dsh-sdk-app`, `@x1a0f3n9/dsh-sdk-minimal`, `@x1a0f3n9/dsh-acp-app`, `@x1a0f3n9/dsh-tui`), then from the profile's own `node_modules`, where pnpm installs out-of-tree plugins.
