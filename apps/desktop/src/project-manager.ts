...
const PROJECT_NAME = '@x1a0f3n9/dsh-desktop-runtime'
const DSH_PACKAGE = '@x1a0f3n9/dsh'
const CORE_BUILD_PACKAGE = '@x1a0f3n9/dsh-subprocess-local'
const DESKTOP_PROFILE_BUNDLES = ['@x1a0f3n9/dsh-base', '@x1a0f3n9/dsh-web-app'] as const
