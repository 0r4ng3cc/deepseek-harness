...
`@x1a0f3n9/dsh-client-web` import `AppWebEntry`、从
`@x1a0f3n9/dsh-client-modules/client` import boot manifest 类型：启动真实 shell 正是该
