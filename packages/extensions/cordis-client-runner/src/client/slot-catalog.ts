...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.right.pane.tab\' (client-ui-sidebar-textpreview), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sidebar-textpreview CodeBody',
      'client-ui-sidebar-textpreview HtmlBody',
      'client-ui-sidebar-textpreview MarkdownBody',
      'client-ui-sidebar-textpreview PdfBody',
      'client-ui-sidebar-textpreview TextBody',
    ],
    replaceRisk: 'none',
    ...
    source: 'packages/client/ui-sidebar-textpreview/src/client/document/contract.ts:23',
  },
  {
