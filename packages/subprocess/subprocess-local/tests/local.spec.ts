...
import type { SubprocessSpawnSpec, SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@x1a0f3n9/dsh-subprocess'
import { childEnv } from '../src/spawn.ts'

function mockWin32ForIsolatedRuntime(): void {
  vi.doMock('@x1a0f3n9/dsh-win32-process', () => ({
...
function unmockWin32ForIsolatedRuntime(): void {
  vi.doUnmock('@x1a0f3n9/dsh-win32-process')
}
