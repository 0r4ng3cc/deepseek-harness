...
The generated [configuration catalog](../../../docs/config-catalog.md#x1a0f3n9dsh-subagent-acp) is the exhaustive source for every accepted field and its JSDoc.
...
```yaml
- id: subagent-acp
  name: '@x1a0f3n9/dsh-subagent-acp'
  config:
    providerName: acp
    command: dsh
...
- [Generated configuration catalog](../../../docs/config-catalog.md#x1a0f3n9dsh-subagent-acp) — every accepted config field and its source declaration.
