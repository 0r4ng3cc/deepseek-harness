...
- [Generated configuration catalog](../../../docs/config-catalog.md#x1a0f3n9dsh-subagent-codex) — every accepted config field and its source declaration.
