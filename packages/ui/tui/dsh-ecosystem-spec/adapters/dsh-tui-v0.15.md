...
**Host:** dsh-TUI 0.9.x（`@deepseek-ai/dsh-tui`）/ Cordis 4.x profile；上游 `@deepseek-ai/*` 主校验线 `0.1.2-alpha.1`（兼容 `0.1.0-rc.6/7/8`、`0.1.1-rc.1/2`）
...
| `hostId` / `hostVersion` | `dsh-tui` / `@deepseek-ai/dsh-tui` package.json 版本（fallback `0.0.0`） |
