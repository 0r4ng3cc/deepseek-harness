/**
 * Re-export of the `@deepseek-ai/dsh-auth` plugin under this
 * package's own name, so the bundle patch layer can mount the OAuth row as
 * `@deepseek-ai/dsh-tui/oauth` instead of the bare package name —
 ...
 * resolution anchored at @deepseek-ai/dsh-tui itself, always a
 * direct profile dependency, under every package-manager layout.
 *
 * @module @deepseek-ai/dsh-tui/oauth
 */
export * from '@deepseek-ai/dsh-auth'
