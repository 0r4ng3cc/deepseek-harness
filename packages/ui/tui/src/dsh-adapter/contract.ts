 ...
 *
 * 0.1.5-alpha.2 = primary workspace line; the 0.1.2 and earlier entries are
 * mapped compatibility lines source-checked when the primary line moves
 * (alpha.5, alpha.4, and alpha.3 among them); 0.1.1-rc.2 and rc.1 are
...
export const UPSTREAM_BLESSED_PACKAGES = [
  ...
  '@x1a0f3n9/dsh-workspace',
  '@x1a0f3n9/dsh-system-prompt',
  '@x1a0f3n9/dsh-terminal',
