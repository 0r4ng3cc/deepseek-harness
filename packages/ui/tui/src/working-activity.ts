 ...
 * `@deepseek-ai/dsh-tui/working-activity` instead of the bare package name.
 *
 ...
 * `dsh-working-activity` name (a transitive dependency of @deepseek-ai/dsh-tui) fails
 ...
 * subpath keeps resolution anchored at @deepseek-ai/dsh-tui itself — always a direct
 ...
 * @module @deepseek-ai/dsh-tui/working-activity
 */
