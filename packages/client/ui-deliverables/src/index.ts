 ...
 * authenticated snapshot downloads. The browser
...
/** Services required for file-reference guidance and authenticated snapshot downloads. */
export const inject = ['systemPrompt', 'connection', 'sessionQuery', 'attachments']
