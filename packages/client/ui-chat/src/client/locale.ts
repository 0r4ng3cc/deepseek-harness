...
export const zh = {
  ...
  'message.delete': '删除本轮及后续记录',
  'message.delete.title': '删除本轮及后续记录？',
  'message.delete.description': '此操作会永久删除当前轮以及后面的全部对话记录，且无法恢复。',
  'message.delete.acknowledge': '我确认永久删除这些对话记录',
  'message.delete.cancel': '取消',
  'message.delete.close': '关闭确认窗口',
  'message.delete.confirm': '永久删除',
...
export const en = {
  ...
  'message.delete': 'Delete this turn and later history',
  'message.delete.title': 'Delete this turn and later history?',
  'message.delete.description': 'This permanently deletes the selected turn and every later conversation record. It cannot be undone.',
  'message.delete.acknowledge': 'I understand that these conversation records will be permanently deleted',
  'message.delete.cancel': 'Cancel',
  'message.delete.close': 'Close confirmation dialog',
  'message.delete.confirm': 'Permanently delete',
