...
export const en = {
  ...
  reasoningEffortNone: 'Default (none)',
  reasoningEffortCustom: 'Custom',
  reasoningEffortWire: 'Sent to the API',
  modelReasoningEmpty: 'Custom reasoning needs at least one thinking level besides off.',
  modelReasoningWireRequired: 'Each selected thinking level needs the value sent to the API. Only off may be blank.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  reasoningEffortNone: '默认（无）',
  reasoningEffortCustom: '自定义',
  reasoningEffortWire: '发给网关',
  modelReasoningEmpty: '自定义思考强度至少要勾选一个 off 以外的档位。',
  modelReasoningWireRequired: '已勾选的思考档位需要填写发给网关的值。只有 off 可以留空。',
