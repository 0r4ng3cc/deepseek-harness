...
The generated [configuration catalog](../../../docs/config-catalog.md#x1a0f3n9dsh-api-workspace-files) is the exhaustive source for every accepted field and its JSDoc.
