...
The generated [configuration catalog](../../../docs/config-catalog.md#x1a0f3n9dsh-api-settings-controller) is the exhaustive source for accepted fields and their JSDoc.
