...
- [Generated tool catalog](../../docs/tool-catalog.md#x1a0f3n9dsh-tool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#x1a0f3n9dsh-goal) — every accepted config field of the goal service.
